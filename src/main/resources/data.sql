...
INSERT INTO public.evs_user (active, created_at, deleted, eligible_to_vote, email, password, updated_at)
SELECT true, CURRENT_TIMESTAMP, false, false, 'admin@gmail.com', '$2a$12$J.l8B5/l4OmOP93xibjoN.5r0o363atWPiOfSrD2bU7HtCWfNh/pK', CURRENT_TIMESTAMP
WHERE NOT EXISTS (
    SELECT 1 
...
INSERT INTO public.evs_user (active, created_at, deleted, eligible_to_vote, email, password, updated_at)
SELECT true, CURRENT_TIMESTAMP, false, false, 'electorial-officer@gmail.com', '$2a$12$EiH3XhLHI9HkDK7J2vesseVp30MCwDSHi1WW8FRd1M0GgPD4xAgga', CURRENT_TIMESTAMP
WHERE NOT EXISTS (
    SELECT 1 
    FROM public.evs_user 
